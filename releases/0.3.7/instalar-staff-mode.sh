...
expected_sha=4d682b0f6a35192f6cddd4754d481e6d2379e38149062aa1e41ec7e9999b388a
source_url=https://raw.githubusercontent.com/csdm-community/csdm-minecraft-plugins/91b21c72e75c2bbb002f2eae41bf532007c860b4/releases/0.3.7/CSDMAdmin.jar
...
download=$(mktemp /root/csdm-admin-0.3.7.XXXXXX.jar)
pending_restart=0
backup=''
cleanup() {
    status=$?
...
backup=$(mktemp -d /opt/csdm-verify/backups/staff-mode-0.3.7.XXXXXX)
...
systemctl is-active --quiet "$service"
pending_restart=0
echo "CSDMAdmin 0.3.7 copiado y arranque solicitado. Respaldo: $backup"
echo 'Cuando termine el arranque, entra y activa /sm y usa el libro del séptimo espacio o /staff sanciones.'
