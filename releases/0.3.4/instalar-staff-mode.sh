...
expected_sha=83e884ecff7618def0cab728edea5428423dcf661bbccde6a3627b92a1857a0b
source_url=https://raw.githubusercontent.com/csdm-community/csdm-minecraft-plugins/2eb5b08a50492ee46ef39cf4a39f3b8ca915087b/releases/0.3.4/CSDMAdmin.jar
...
download=$(mktemp /root/csdm-admin-0.3.4.XXXXXX.jar)
pending_restart=0
backup=''
cleanup() {
    status=$?
...
backup=$(mktemp -d /opt/csdm-verify/backups/staff-mode-0.3.4.XXXXXX)
...
systemctl is-active --quiet "$service"
pending_restart=0
echo "CSDMAdmin 0.3.4 copiado y arranque solicitado. Respaldo: $backup"
echo 'Cuando termine el arranque, entra y prueba /sm y /staff aleatorio.'
