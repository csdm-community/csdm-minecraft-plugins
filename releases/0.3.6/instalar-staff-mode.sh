...
expected_sha=7c5446f2fdfa02a2068490afaf91f9d8a438c59a321d2db48050b274e9589c73
source_url=https://raw.githubusercontent.com/csdm-community/csdm-minecraft-plugins/5112648c2bc69745936b19d2157f4edab7da428f/releases/0.3.6/CSDMAdmin.jar
...
download=$(mktemp /root/csdm-admin-0.3.6.XXXXXX.jar)
pending_restart=0
backup=''
cleanup() {
    status=$?
...
backup=$(mktemp -d /opt/csdm-verify/backups/staff-mode-0.3.6.XXXXXX)
...
systemctl is-active --quiet "$service"
pending_restart=0
echo "CSDMAdmin 0.3.6 copiado y arranque solicitado. Respaldo: $backup"
